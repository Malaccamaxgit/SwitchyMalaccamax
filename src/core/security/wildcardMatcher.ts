...
export class WildcardMatcher {
   ...
   */
  private static matchPatternInternal(pattern: string, host: string): boolean {
 ...
 */
export function matchWildcard(patterns: string | string[], host: string): boolean {
 ...
 * @returns Validation result
 */
export function validateWildcard(patterns: string | string[]): WildcardValidationResult {
